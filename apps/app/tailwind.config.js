...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        // 字体栈整体下沉为 CSS 变量，后台 Theme.tokens.font 可在运行时覆盖（见 src/theme/applyTheme.ts）
        'serif-sc': 'var(--f-serif-sc)',
        'sans-sc': 'var(--f-sans-sc)',
        'latin': 'var(--f-latin)',
      },
      colors: {
        // 品牌色存 RGB 三元组（如 "245 242 231"），配 <alpha-value> 保留 bg-forest-deep/85 这类透明度写法
        cream: {
        ...
        forest: {
          ...
          mist: 'rgb(var(--c-forest-mist) / <alpha-value>)',
        },
        gold: {
